...
// BOLT: Pre-instantiate formatters to avoid expensive object creation in render loops
    ...
    const processLogs = (logList: any[], isRival: boolean) => {
      logList.forEach(log => {
        ...
        if (currentViewMode === 'monthly') {
          ...
          // BOLT: Use pre-instantiated formatter for ~5-10x faster formatting than toLocaleDateString()
