...
// BOLT: Reusable formatters to avoid expensive Intl instantiation in loops
    ...
    const processLogs = (logList: any[], isRival: boolean) => {
      logList.forEach(log => {
        ...
        if (currentViewMode === 'monthly') {
          ...
          // BOLT: Use pre-instantiated formatter for better performance than toLocaleDateString()
          ...
          // BOLT: Use pre-instantiated formatter for better performance
