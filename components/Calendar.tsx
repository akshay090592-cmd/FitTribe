...
// BOLT: Hoist static week days array to module scope to eliminate array allocations on every component render.
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 mb-6">
            ...
            <div className="grid grid-cols-7 gap-1 text-center mb-2">
                {WEEK_DAYS.map((d, index) => (
                    <div key={`${d}-${index}`} className="text-[10px] font-bold text-slate-400 uppercase">
                        {d}
                    </div>
                ))}
            </div>
