...
export const Leaderboard: React.FC<Props> = React.memo(({ logs, gamificationState, members, avatarMap = {}, onUserClick }) => {
    ...
    return (
        <div className="glass-panel overflow-hidden mb-6 font-sans spring-transition">
            <div className="bg-gradient-to-br from-emerald-800 to-emerald-950 p-5 foliage-pattern relative">
                <div className="flex justify-between items-center mb-4 relative z-10">
                    <h3 className="text-white font-bold text-xl flex items-center font-['Fredoka']">
                        <Crown size={24} className="mr-2 text-yellow-400 fill-yellow-400" /> Arena Rankings
                    </h3>

                </div>

                <div className="flex bg-emerald-900/50 rounded-xl p-1 border border-white/5 relative z-10">
            ...
            <div className="p-2 space-y-1">
                {sortedUsers.map((user, idx) => {
                    ...
                    return (
                        <div key={user} onClick={() => onUserClick?.(user)} className="flex items-center justify-between p-3 border-b border-slate-50/50 last:border-0 hover:bg-emerald-50/20 transition-all rounded-xl group cursor-pointer active:scale-[0.98] transform duration-200">
                            ...
                            <div className="flex flex-col items-end">
                                <div className="text-xs font-bold text-emerald-600 bg-emerald-50/30 px-2 py-1 rounded-lg flex items-center group-hover:bg-emerald-100 transition-colors">
            ...
            <div className="bg-emerald-50/30 border-t border-emerald-100 p-3 text-center flex items-center justify-center">
