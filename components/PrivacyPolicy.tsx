    ...
    return (
        ...
        >
            ...
            <section className="space-y-6">
                ...
                <h2 className="text-2xl font-bold text-slate-800 font-['Fredoka'] mt-8">Google Health & Health Data</h2>
                <p>If you choose to connect your Google Health account, FitTribe collects and accesses the following metrics to enhance your fitness tracking:</p>
                <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li><strong>Workout Sessions:</strong> We write your completed sessions back to Google Health to centralize your training history.</li>
                </ul>
                <p>FitTribe does not share your Google Health or health data with third parties or use it for advertising purposes. Your health data is processed client-side and saved securely in your private profile database.</p>
