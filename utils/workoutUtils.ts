...
/**
 * BOLT: Bounded Map cache for parsed durations to completely bypass string lowercasing,
 * trimming, splitting, and regular expression matching on recurring duration inputs.
 * Bounded to 1000 items to prevent potential memory bloat.
 */
const durationCache = new Map<string, number>();

/**
 * Clears the duration cache. Primarily used in test isolation/beforeEach hooks.
 */
...
/**
 * BOLT: Optimized parseDurationToSeconds with Map-based caching.
...
export const parseDurationToSeconds = (durationStr: string | undefined): number => {
    ...
    // Guard against memory expansion
